...
namespace GoblinEngine
{
	namespace DirectX
	{
		public enum class Usage : unsigned
		{
			Default,
			Immutable,
			Dynamic,
		...
		public enum class GraphicFormat : unsigned
		{
			UNKNOWN = 0,
		...
		public enum class GraphicModes : unsigned
		{
			Interlaced = 1,
			Scaling = 2,
			Stereo = 4,
		...
		public enum class GraphicModeScanlineOrder : unsigned
		{
			Unspecified,
			Progressive,
			UpperFieldFirst,
		...
		public enum class GraphicModeScaling : unsigned
		{
			Unspecified,
			Centered,
			Stretched
		...
		public enum class GraphicModeRotation : unsigned
		{
			Unspecified,
			Identity,
			Rotate90,
		...
		public enum class SwapEffect : unsigned
		{
			Discard = 0,
			Sequential = 1,
			FlipSequential = 3,
		...
		public enum class SwapChainFlag : unsigned
		{
			Nonprerotated = 1,
			AllowModeSwitch = 2,
			GDICompatible = 4,
		...
		public enum class GraphicUsage : unsigned
		{
		...
		public enum class DriverType : unsigned
		{
			Unknown,
			Hardware,
			Reference,
		...
		public enum class FeatureLevel : unsigned
		{
			_1_0_CORE = 0x1000,
			_9_1 = 0x9100,
			_9_2 = 0x9200,
